...
const sections: Section[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Kiran Watermelon", price: 98, oldPrice: 116, rating: 4.7, pack: "2 kg", tag: "Summer", query: "watermelon slice" },
      { name: "Raw Mango (Mamidikaya)", price: 23, oldPrice: 28, rating: 4.5, pack: "500 g", tag: "Tangy", query: "raw green mango" },
      { name: "Thai Pink Guava", price: 82, oldPrice: 104, rating: 4.6, pack: "400 g", tag: "Premium", query: "pink guava" },
    ],
  },
  {
    title: "Snacks",
    products: [
      { name: "Crax Biggies Cheese Puffs", price: 33, oldPrice: 60, rating: 4.6, pack: "70 g", tag: "Cheesy", query: "cheese puffs snack" },
      { name: "Lay's West Indies Hot n Sweet", price: 25, oldPrice: 30, rating: 4.5, pack: "58 g", tag: "Tangy", query: "lays potato chips bag" },
      { name: "Bingo Original Chilli Chips", price: 19, oldPrice: 20, rating: 4.7, pack: "43 g", tag: "Spicy", query: "potato chips bag" },
      { name: "Lay's American Cream & Onion", price: 25, oldPrice: 30, rating: 4.8, pack: "58 g", tag: "Creamy", query: "cream onion chips" },
      { name: "Lay's India's Magic Masala", price: 25, oldPrice: 30, rating: 4.7, pack: "58 g", tag: "Masala", query: "masala chips packet" },
      { name: "Kurkure Puffcorn Cheese", price: 20, oldPrice: 25, rating: 4.6, pack: "58 g", tag: "Puff", query: "puffcorn snack" },
    ],
  },
  {
    title: "Drinks",
